...
var inputElement = document.getElementById("weightInput");
var ouncesButton = document.getElementById("ouncesButton");
ouncesButton.addEventListener("click", ounces);
var gramsButton = document.getElementById("gramsButton");
gramsButton.addEventListener("click", grams);
var outputElement = document.getElementById("weightOutput");
function ounces() {
    var inputWeight = inputElement.value;
    var conversion = (parseInt(inputWeight) * 0.0352739619);
    outputElement.innerHTML = conversion.toString();
}
function grams() {
    var inputWeight = inputElement.value;
    var conversion = (parseInt(inputWeight) * 28.3495231);
    outputElement.innerHTML = conversion.toString();
}
